...
Human interpretation is part of \sculpt's exercise as a \emph{performative act}: walking through the pieces and applying instructions is itself an embodied gesture that belongs to the language, not a step external to it.
This performative dimension is also what makes the interpretation unreliable.
