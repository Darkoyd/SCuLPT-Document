...
Este art\'iculo presenta \sculpt, un lenguaje de programaci\'on
...
de 13 instrucciones que operan sobre pilas LIFO, se demostr\'o
...
La validaci\'on con mostr\'o un patr\'on consistente.
...
Quedan abiertas varias l\'ineas de investigaci\'on sobre el lenguaje y sus capacidades artisticas educacionales.
Primero, estudios m\'as extensos en
...
Agregar elementos como un sistema de manejo de errores m\'as informativo, herramientas de apoyo como un \emph{language server} con
\emph{syntax highlighting} y completaci\'on de comandos, y un visualizador que
...
m\'as que una particularidad es el llamado
