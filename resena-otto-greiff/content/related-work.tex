...
con funciones de primer orden y bloques personalizables, orientada a la
...
expl\'icitamente a la producci\'on art\'istica. \emph{Processing}~\cite{reas07processing}, ofrece un dialecto de Java pensado
...
\emph{Sonic Pi}~\cite{aaron16sonicpi}, construye
...
la producci\'on art\'istica final es sonido, video o imagen, no el cuerpo f\'isico del
programa.
...
Finalmente, comparte con la tradici\'on del \emph{creative computing} la convicci\'on
